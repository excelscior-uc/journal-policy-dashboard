export const FIELDS = [
  { slug: 'all-fields',         name: 'All Research Fields',              icon: '🌐', totalJournals: 213, withPolicy: 86 },
  ...
  { slug: 'genetics',           name: 'Genetics & Heredity',              icon: '🧬', totalJournals: 28,  withPolicy: 10 },
  { slug: 'immunology',         name: 'Immunology',                       icon: '🛡️', totalJournals: 25,  withPolicy: 7  },
  { slug: 'neurosciences',      name: 'Neurosciences',                    icon: '🔭', totalJournals: 21,  withPolicy: 7  },
